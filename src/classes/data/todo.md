...
- Certain class archetypes, like the Seneschal Witch and the Warrior of Legend, currently only serve to take up space and need something to distinguish them
  ...
  - I could add a "Witch" object, or a more general "Special" object, and add a very optional "Patron" property to it, to distinguish the Seneschal and regular witch
  - Similarly, the theme property, mentioned further above, might allow me to support the Elementalist, perhaps with an "Elemental" theme, and maybe others, like with a "Mythic" theme; but generally it still feels too subjective
